...
<div id="inspection-report" class="printArea container-fluid pre-scrollable" style="min-height: 40em; width: 98%; background-color: #fff;">
    <div class="row">
            <div class="invoice-title">
                <h2 align="center">Punjab State Seed Certification Authority</h2>
                <h3 align="center">Inspection Register</h3>
            </div>
    ...
    <div class="row" style="font-size: 15px;">
		<div class="col-md-6">	    			
	    	Season Name (Rabi / Kharif / Summer):	<span class="dotted-field">
	    					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    					<?php if(!empty($list[0]->season)) { echo $list[0]->season; }?>
	    					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    				</span>
	    </div>
	    <div class="col-md-4">
