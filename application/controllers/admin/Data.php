...
class Data extends Admin_Controller
{
  ...
  public function exportrules(){
        ...
        #$result = $this->db->query($query); Ifc_Structure_Attribute
        #$report_result =  $this->data_model->get_data_result();

  $query = "SELECT ruleinputparameters.* , rule.name as RuleName,ruleset.name as RuleSetName ,structureattributes.StructureAttributesName , structureelements.StructureElementName
            FROM ruleinputparameters INNER JOIN rule ON 
            ruleinputparameters.RuleID = rule.rule_id INNER JOIN 
            ruleset ON ruleinputparameters.ruleset_id = ruleset.ruleset_id 
            INNER JOIN 
            structureattributes ON ruleinputparameters.Ifc_Structure_Attribute = structureattributes.StructureAttributeID 
               INNER JOIN 
            structureelements ON ruleinputparameters.StructureElementID = structureelements.StructureElementID 
        ...
        #$result = $this->freezrule->get_data4export();
